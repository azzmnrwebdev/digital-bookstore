            ...
            <div class="card mb-4 shadow-none">
                ...
                <div class="card-body px-0 pb-0 pt-2">
                    <div class="position-relative mb-custom">
                        <img src="{{ $admin->background ? asset($admin->background) : asset('assets/image/no-image.png') }}"
                            id="backgroundView" class="background-image rounded" alt="Background Image">

                        <img src="{{ $admin->avatar ? asset($admin->avatar) : asset('assets/image/empty.jpg') }}"
                            id="avatarView" class="profile-image position-absolute" style="" alt="Foto Profile">
                    </div>
                </div>
            </div>

            <form action="{{ route('admin.update_profile', $userLogin->id) }}" method="post"
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label"
                                for="avatar">{{ $admin->avatar ? 'Change avatar' : 'Choose avatar' }}</label>
                    ...
                    <div class="form-group col-12 col-md-6">
                        ...
                        <div class="custom-file">
                            <input type="file" name="background" id="background"
                                ...
                                accept=".png, .jpg, .jpeg">
                            <label class="custom-file-label"
                                for="background">{{ $admin->background ? 'Change background' : 'Choose background' }}</label>
