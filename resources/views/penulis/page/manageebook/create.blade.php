...
@section('title-head', 'Upload Ebook')
@section('title-content', 'Upload Ebook')
        ...
        <div class="col-12">
            <div class="card" style="border-top: 4px solid #42B549;">
                <div class="card-body">
                    ...
                    <div class="card mb-4 shadow-none d-none" id="thumbnailPreview">
                        <div class="card-header" style="background-color: #d8f8e2">
                            <h3 class="card-title">{{ __('Thumbnail Preview') }}</h3>
                        </div>

                        <div class="card-body px-0 pb-0 pt-2">
                            <img src="" id="thumbnailView" class="rounded" width="250px;" alt="Thumbnail Image">
                        </div>
                    </div>

                    <form action="{{ route('penulis.ebook.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <input type="text" name="isbn" id="isbn"
                                    ...
                                    placeholder="Cth:9786028519939" value="{{ old('isbn') }}" pattern="[0-9]{10,13}"
                                    maxlength="13">
                            ...
                            <div class="form-group col-12">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="free" {{ old('status') === 'free' ? 'selected' : '' }}>
                                        {{ __('Free') }}
                                    </option>
                            ...
                            <div class="form-group col-12 d-none" id="inputPrice">
                                ...
                                <input type="text" name="price" id="price"
                                    ...
                                    placeholder="Price, cth:100000" value="{{ old('price') }}">
                                    ...
                                    <select name="author_ids[]" id="author_ids"
                                        ...
                                        @foreach ($authors as $author)
                                            <option value="{{ $author->id }}"
                                                @if (is_array(old('author_ids')) && in_array($author->id, old('author_ids'))) selected @endif>
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="custom-file">
                                    <input type="file" name="thumbnail" id="thumbnail"
                                        ...
                                        accept=".png, .jpg, .jpeg">
                                    <label class="custom-file-label" for="thumbnail">{{ __('Choose thumbnail') }}</label>
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="pdf">{{ __('Choose ebook') }}</label>

                                    <small id="pdfHelp" class="form-text text-muted">Upload file ebook ukuran maksimal 10MB</small>
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="text" name="password" id="password" class="form-control"
                                    placeholder="Password ebook" value="{{ old('password') }}"
                        ...
                        <button type="submit" class="btn btn-sm btn-success"><i
                                class="fas fa-check mr-3"></i>{{ __('Save Ebook') }}</button>
                    </form>
                </div>
            </div>
        </div>
