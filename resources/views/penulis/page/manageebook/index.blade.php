...
@section('title-head', 'Manage Ebook')
@section('title-content', 'Manage Ebook')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('Manage Ebook') }}</li>
@endsection
                ...
                <div class="col-lg-4 col-xl-3">
                    <div class="card shadow-none">
                        ...
                        <div class="card-body px-0 pb-0">
                            <div class="mb-3">
                                <label for="search" class="form-label">{{ __('Search Ebook') }}</label>
                                    ...
                                    <div class="card card-ebook shadow-sm h-100" style="border: 1px solid #CED4DA;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-2 text-right">
                                                <form action="{{ route('penulis.ebook.delete', $ebook->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')

                                                    {{-- button edit --}}
                                                    <a href="{{ route('penulis.ebook.edit', $ebook->slug) }}"
...
@prepend('scripts')
    ...
    <script>
        ...
        function filter() {
            ...
            const params = {};
            const url = '{{ route('penulis.ebook.index') }}';
